...
<style>
  .sr-wrap{font-family:system-ui,-apple-system,'Segoe UI',sans-serif;padding:.5rem 0;color:#1f2937;background:#ffffff}
  .sr-title{font-size:14px;font-weight:700;color:#000000;margin:0 0 12px}
  .sr-blocks{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin:0 0 10px}
  .sr-block{border-radius:10px;padding:14px 12px;border:.5px solid #d1d5db;background:#f9fafb;display:flex;flex-direction:column;gap:8px;position:relative;overflow:hidden}

  /* Colored top accent bar */
  .sr-block::before{content:'';position:absolute;top:0;left:0;right:0;height:3px}
  .sr-block-8::before{background:#6b7280}
  .sr-block-16::before{background:#2563eb}
  .sr-block-24::before{background:#059669}
  .sr-block-48::before{background:#7c3aed}

  .sr-icon{font-size:18px;line-height:1}
  .sr-label{font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase}
  .sr-label-8{color:#4b5563}
  .sr-label-16{color:#1e40af}
  .sr-label-24{color:#065f46}
  .sr-label-48{color:#5b21b6}

  .sr-freq{font-size:22px;font-weight:700;font-family:ui-monospace,'Cascadia Code',monospace;line-height:1.1}
  .sr-freq-8{color:#374151}
  .sr-freq-16{color:#1e40af}
  .sr-freq-24{color:#059669}
  .sr-freq-48{color:#7c3aed}
  .sr-unit{font-size:12px;font-weight:400}

  .sr-note{font-size:11px;color:#374151;line-height:1.4}
  .sr-context{font-size:10px;color:#4b5563;font-family:ui-monospace,'Cascadia Code',monospace}

  .sr-codec{display:inline-block;font-size:9px;font-weight:700;padding:2px 6px;border-radius:3px;letter-spacing:.03em}
  .codec-8{background:#f3f4f6;color:#4b5563}
  .codec-16{background:#dbeafe;color:#1e40af}
  .codec-24{background:#d1fae5;color:#065f46}
  .codec-48{background:#ede9fe;color:#5b21b6}

  .sr-quality{margin:2px 0 0}
  .sr-quality-label{font-size:10px;color:#6b7280;margin:0 0 4px}
  .sr-quality-track{height:4px;border-radius:2px;background:#e5e7eb;overflow:hidden}
  .sr-quality-fill{height:100%;border-radius:2px}
  .fill-8{width:25%;background:#9ca3af}
  .fill-16{width:50%;background:#2563eb}
  .fill-24{width:75%;background:#059669}
  .fill-48{width:100%;background:linear-gradient(90deg,#7c3aed,#a855f7)}

  /* Conversion bridge */
  .sr-bridge-wrap{background:#f9fafb;border-radius:8px;padding:12px 14px;margin:0 0 8px;border:.5px solid #d1d5db}
  .sr-bridge-title{font-size:12px;font-weight:500;color:#000000;margin:0 0 10px}
  ...
  .sr-bridge-khz{font-size:13px;font-weight:700;font-family:ui-monospace,'Cascadia Code',monospace;color:#111827}
  .sr-bridge-who{font-size:9px;color:#4b5563;text-align:center;line-height:1.3}
  .sr-bridge-arr{font-size:13px;color:#6b7280;flex-shrink:0}
  ...
  .op-up{background:#dbeafe;color:#1e40af}
  .op-down{background:#fed7aa;color:#92400e}

  .note-box{background:#eff6ff;border-radius:8px;padding:10px 14px;font-size:12px;color:#1e3a8a;line-height:1.5;border:.5px solid #bfdbfe}
...
<style>
  .wrap{font-family:system-ui,-apple-system,'Segoe UI',sans-serif;padding:.5rem 0;color:#1f2937;background:#ffffff}
